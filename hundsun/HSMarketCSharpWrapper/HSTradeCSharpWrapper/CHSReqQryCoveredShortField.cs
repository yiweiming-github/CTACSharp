...
public class CHSReqQryCoveredShortField : global::System.IDisposable {
  ...
  public virtual void Dispose() {
    lock(this) {
      if (swigCPtr.Handle != global::System.IntPtr.Zero) {
        if (swigCMemOwn) {
          swigCMemOwn = false;
          HSTradeCppWrapperPINVOKE.delete_CHSReqQryCoveredShortField(swigCPtr);
        }
  ...
  public string ExchangeID {
    set {
      HSTradeCppWrapperPINVOKE.CHSReqQryCoveredShortField_ExchangeID_set(swigCPtr, value);
    } 
    get {
      string ret = HSTradeCppWrapperPINVOKE.CHSReqQryCoveredShortField_ExchangeID_get(swigCPtr);
      return ret;
    } 
  }
