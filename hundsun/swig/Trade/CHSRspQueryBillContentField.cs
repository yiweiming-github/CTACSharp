...
public class CHSRspQueryBillContentField : global::System.IDisposable {
  ...
  public virtual void Dispose() {
    lock(this) {
      if (swigCPtr.Handle != global::System.IntPtr.Zero) {
        if (swigCMemOwn) {
          swigCMemOwn = false;
          HSTradeCppWrapperPINVOKE.delete_CHSRspQueryBillContentField(swigCPtr);
        }
  ...
  public string BillContent {
    set {
      HSTradeCppWrapperPINVOKE.CHSRspQueryBillContentField_BillContent_set(swigCPtr, value);
    } 
    get {
      string ret = HSTradeCppWrapperPINVOKE.CHSRspQueryBillContentField_BillContent_get(swigCPtr);
      return ret;
    } 
  }
