...
public class CThostFtdcMdApi : global::System.IDisposable {
  ...
  public virtual int SubscribeMarketData(string[] ppInstrumentID, int nCount) {
    int ret = CTPMarketCppWrapperPINVOKE.CThostFtdcMdApi_SubscribeMarketData(swigCPtr, ppInstrumentID, nCount);
    return ret;
  }

  public virtual int UnSubscribeMarketData(string[] ppInstrumentID, int nCount) {
    int ret = CTPMarketCppWrapperPINVOKE.CThostFtdcMdApi_UnSubscribeMarketData(swigCPtr, ppInstrumentID, nCount);
    return ret;
  }

  public virtual int SubscribeForQuoteRsp(string[] ppInstrumentID, int nCount) {
    int ret = CTPMarketCppWrapperPINVOKE.CThostFtdcMdApi_SubscribeForQuoteRsp(swigCPtr, ppInstrumentID, nCount);
    return ret;
  }
