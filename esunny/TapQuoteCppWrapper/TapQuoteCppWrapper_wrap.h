...
public:
    ...
    virtual TAPIINT32 TAP_CDECL Login(TapAPIQuoteLoginAuth const *loginAuth);
    ...
    virtual TAPIINT32 TAP_CDECL SubscribeQuote(TAPIUINT32 *sessionID, TapAPIContract const *contract);
    virtual TAPIINT32 TAP_CDECL UnSubscribeQuote(TAPIUINT32 *sessionID, TapAPIContract const *contract);
