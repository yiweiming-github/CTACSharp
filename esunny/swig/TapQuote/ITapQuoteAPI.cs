...
public class ITapQuoteAPI : global::System.IDisposable {
  ...
  public virtual int QryCommodity(ref uint sessionID) {
    int ret = TapQuoteCppWrapperPINVOKE.ITapQuoteAPI_QryCommodity(swigCPtr, SWIGTYPE_p_unsigned_int.getCPtr(sessionID));
    return ret;
  }

  public virtual int QryContract(ref uint sessionID, TapAPICommodity qryReq) {
    int ret = TapQuoteCppWrapperPINVOKE.ITapQuoteAPI_QryContract(swigCPtr, SWIGTYPE_p_unsigned_int.getCPtr(sessionID), TapAPICommodity.getCPtr(qryReq));
    return ret;
  }

  public virtual int SubscribeQuote(ref uint sessionID, TapAPIContract contract) {
    int ret = TapQuoteCppWrapperPINVOKE.ITapQuoteAPI_SubscribeQuote(swigCPtr, SWIGTYPE_p_unsigned_int.getCPtr(sessionID), TapAPIContract.getCPtr(contract));
    return ret;
  }

  public virtual int UnSubscribeQuote(ref uint sessionID, TapAPIContract contract) {
    int ret = TapQuoteCppWrapperPINVOKE.ITapQuoteAPI_UnSubscribeQuote(swigCPtr, SWIGTYPE_p_unsigned_int.getCPtr(sessionID), TapAPIContract.getCPtr(contract));
    return ret;
  }
  ...
  private int SwigDirectorSubscribeQuote(ref uint sessionID, global::System.IntPtr contract) {
    return SubscribeQuote((sessionID == global::System.IntPtr.Zero) ? null : new SWIGTYPE_p_unsigned_int(sessionID, false), (contract == global::System.IntPtr.Zero) ? null : new TapAPIContract(contract, false));
  }

  private int SwigDirectorUnSubscribeQuote(ref uint sessionID, global::System.IntPtr contract) {
    return UnSubscribeQuote((sessionID == global::System.IntPtr.Zero) ? null : new SWIGTYPE_p_unsigned_int(sessionID, false), (contract == global::System.IntPtr.Zero) ? null : new TapAPIContract(contract, false));
  }
